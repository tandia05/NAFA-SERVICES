...
$destinataire='mohamedtandia05s@gmail.com';  
...
<head>  
  ...
  <style type="text/css">  
    ...
    p#msg textarea{border:2px solid orange;height:30em;width:80%}  
    p#adr input,p#obj input{border:2px solid orange}  
...
<form id='contact' method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">  
  ...
  <textarea tabindex="30" rows="5" cols="120" name="message" id="message"><?php echo $message; ?></textarea>  
  </label></p>  
